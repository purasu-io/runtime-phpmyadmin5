...
$cookieSecret = $_ENV['SECRET_COOKIE_BASE'];
if (empty($cookieSecret)) {
  die("Abort: Empty SECRET_COOKIE_BASE");
}
$cfg['blowfish_secret'] = $cookieSecret;
$cfg['TempDir'] = "/tmp";

// https://github.com/phpmyadmin/docker/blob/5.0.4/apache/config.inc.php
...
for ($i = 1; isset($hosts[$i - 1]); $i++) {
    ...
    // Does not work with "mysql.namespace"
    // ssl verification fails because CommonName is "mysql.namespace" instaed of "*.rds.amazonaws.com"
